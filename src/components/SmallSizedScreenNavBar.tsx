...
const SmallSizedScreenNavBar = () => {
    ...
    return (
        <div className='md:hidden grid grid-cols-4 relative text-[#4d4d4d] text-sm'>
            ...
            <input type="text" className='outline-none col-span-3 p-2' placeholder='Search' />
            <div ref={ref}>
                {isComponentVisible && <div className='absolute top-10 bg-white left-5 w-[50%] rounded-lg shadow-lg' style={{ zIndex: 2000 }} >
                    <div className='flex justify-between px-10 py-3'>
                        <button>Login</button>
                        <button>Sign Up</button>
                    </div>
                    <div className='h-[1px] bg-gray-300 w-full' />
                    <div className='flex flex-col space-y-3 text-gray-500 p-5'>
